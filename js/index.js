$(document).ready(function() {
	for (i=0; i<20; i++)
		$(".layer-red:first-child")
			.clone()
			.css("top", "calc(50% - "+i+"px)")
			.insertBefore(".layer-red:first-child")

	for (i=0; i<20; i++)
		$(".layer-pink:first-child")
			.clone()
			.css("top", "calc(50% - "+i+"px)")
			.insertAfter(".layer-pink:first-child")

	$(".text")
		.css("top", $(".layer4 .layer-pink:last-child").offset().top-45)
		.css("left", $(".layer4 .layer-pink:last-child").offset().left)
